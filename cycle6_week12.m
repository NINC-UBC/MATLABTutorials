...
% is on. uigetfile is a function which can return a list of files selected
...
% As we have seen before for random normally distributed numbers, the mean 
...
% Objects extend the idea of grouping output arguments of a function using
